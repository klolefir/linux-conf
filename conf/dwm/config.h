...
static const char *pdfreadercmd[] = { "/home/klolefir/scripts/zathura/zathura.tcl", NULL };
static const char *telegramcmd[] = { "telegram", NULL };
static const char *translatorcmd[] = { "vimb", "wooordhunt.ru", NULL };
//static const char *vivadocmd[] = {"/home/klolefir/soft/vivadooo/Vivado/2019.1/bin/vivado", "-nojournal", "-nolog", NULL };
...
static const Key keys[] = {
	...
	{ MODKEY|ShiftMask,		XK_r,	   spawn,	   {.v = pdfreadercmd } },
	{ MODKEY|ShiftMask,		XK_w,	   spawn,	   {.v = translatorcmd } },
	//{ MODKEY|ShiftMask,		XK_v,	   spawn,	   {.v = vivadocmd } },
	#if KEYMODES_PATCH
