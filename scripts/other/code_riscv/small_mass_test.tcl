...
#set instr [ string replace $instr $immI_ind_f $immI_ind_l [ string range $imm 20 31 ] ]
...
set instr [ string replace $instr $immS_ind_ff $immS_ind_fl [ string range $imm 5 11 ] ]
set instr [ string replace $instr $immS_ind_lf $immS_ind_ll [string range $imm 0 4 ] ]
