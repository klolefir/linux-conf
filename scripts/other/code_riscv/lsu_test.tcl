...
for { set i 0 } { $i <= $N } { incr i } { 
	...
	set instr [ string replace $instr $immS_ind_ff $immS_ind_fl 0000001 ]
	set instr [ string replace $instr $immS_ind_lf $immS_ind_ll 00001 ]
...
set const 1
set const_width 32
set const [ num2bin $const [ expr $const_width - 1 ] ]
puts $fd $const
}
